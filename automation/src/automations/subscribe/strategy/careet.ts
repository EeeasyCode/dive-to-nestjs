...
export class Careet implements SubscribeStrategy {
  async subscribe(email: string) {
    try {
      ...
      await page.click(
        '#frm12 > div.policy-bottom--wrap > div.checkbox--wrap > div:nth-child(1)',
      );
      await page.click(
        '#informationEditPopup > div > div.popup-content > div > div.button-wrap > button',
      );
      await page.click(
        '#frm12 > div.policy-bottom--wrap > div.checkbox--wrap > div:nth-child(2)',
      );
      await page.click(
        '#informationEditPopup > div > div.popup-content > div > div.button-wrap > button',
      );
